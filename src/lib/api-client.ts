...
const GATEWAY_WS_DIAG_FLAG = 'oneclaw:gateway-ws-diagnostic';
...
function shouldLogApiRequests(): boolean {
  try {
    return import.meta.env.DEV || window.localStorage.getItem('oneclaw:api-log') === '1';
  } catch {
