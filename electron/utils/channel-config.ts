...
// schema validation errors.  OneClaw falls back to DEFAULT_ACCOUNT_ID
...
// but whose account payload contains nested strict-schema objects that OneClaw
...
function sanitizeDiscordGuildChannelConfig(channelConfig: unknown): void {
    ...
    // Backward compatibility for the older OneClaw-generated shape:
...
export async function saveChannelConfig(
    ...
    return withConfigLock(async () => {
        ...
        // but OneClaw still keeps channels.<id> as the local account-list source.
        ...
        // while preserving channels.<id> for OneClaw's account list UI.
