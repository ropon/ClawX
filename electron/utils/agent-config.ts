...
import { ensureOneClawIdentityFile } from './openclaw-workspace';
...
async function provisionAgentFilesystem(
  ...
  // on first use, but OneClaw still pre-seeds IDENTITY.md so desktop workspaces
  ...
  await ensureOneClawIdentityFile(targetWorkspace, { createDir: true });
