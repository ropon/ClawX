...
const LOCALHOST_FALLBACK_FLAG = 'oneclaw:allow-localhost-fallback';
const SSE_FALLBACK_FLAG = 'oneclaw:allow-sse-fallback';
const WS_DIAGNOSTIC_FLAG = 'oneclaw:gateway-ws-diagnostic';
