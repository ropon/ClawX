#!/usr/bin/env node
/**
 * Generates extension bridge files based on oneclaw-extensions.json and
...
const MANIFEST_PATH = resolve(ROOT, 'oneclaw-extensions.json');
...
function generateMainBridge(manifest) {
  ...
  if (installedExts.length === 0) {
    return [
      ...
      '// To add extensions, configure oneclaw-extensions.json and link the package.',
